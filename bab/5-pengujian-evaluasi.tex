...
Pengujian modul koreksi dilakukan dengan membandingkan citra hasil restorasi \textit{Generator} terhadap citra asli untuk melihat sejauh mana kualitas citra dapat dipulihkan. Hasil evaluasi menunjukkan performa yang sangat baik dengan rata-rata nilai PSNR sebesar 35.75 dB dan SSIM sebesar 0.9166. Nilai PSNR yang tinggi ini menunjukkan keberhasilan model dalam menekan gangguan artefak dan noise, sehingga citra menjadi lebih bersih. Sementara itu, nilai SSIM yang berada di atas 0.91 membuktikan bahwa detail penting pada anatomi otak, seperti ventrikel dan batas jaringan, tetap terjaga dengan akurat tanpa mengalami perubahan struktur yang signifikan selama proses koreksi.
...
Secara kualitatif, perbandingan pada Gambar \ref{fig:ganimagecompare} memperlihatkan transformasi citra dari yang semula sedikit buram (\textit{ghosting}) menjadi citra yang jernih. Hasil prediksi \textit{Generator} terlihat hampir identik dengan citra target yang membuktikan bahwa Pix2Pix GAN efektif dalam memulihkan detail visual yang hilang akibat gerakan pasien. Model terbukti sangat mumpuni dalam membersihkan area latar belakang yang gelap sekaligus mempertajam kembali garis-garis anatomis otak. Dengan kualitas hasil rekonstruksi yang tinggi, citra tersebut  dapat diproses lebih lanjut oleh sistem diagnosis otomatis di tahap berikutnya.
