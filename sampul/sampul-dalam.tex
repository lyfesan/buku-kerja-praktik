...
\newgeometry{top=60mm,left=25mm,right=20mm,bottom=25mm}
...
\begin{flushleft}
  ...
  {
  	\setstretch{1.2}
  	\noindent {\Large \textbf{PENGEMBANGAN MODUL KOREKSI DAN KLASIFIKASI ARTEFAK CITRA OTAK SEBAGAI BAGIAN DARI SISTEM \textit{FAULT TOLERANCE IMAGE CAPTIONING}}}
  	\vspace{2ex}
  	\par
  }
